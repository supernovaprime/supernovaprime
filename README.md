...
<svg width="860" height="280" viewBox="0 0 860 280" xmlns="http://www.w3.org/2000/svg">
  ...
  <rect x="300" y="100" width="240" height="80" rx="6" fill="#0d0d0f" stroke="url(#neonGradient)" stroke-width="1"/>
  <rect x="305" y="105" width="230" height="70" fill="#0a0a12"/>
  <text x="310" y="120" font-family="JetBrains Mono" font-size="8" fill="#39ff14">supernovaprime@dev:</text>
  <text x="310" y="132" font-family="JetBrains Mono" font-size="8" fill="#00d4ff">~</text>
  <text x="315" y="132" font-family="JetBrains Mono" font-size="8" fill="#39ff14">$</text>
  <text x="320" y="147" font-family="JetBrains Mono" font-size="8" fill="#bc13fe">Building the future..</text>
  <line x="470" y1="147" x2="472" y2="147" stroke="#39ff14" stroke-width="1"><animate attributeName="opacity" values="1;0;1" dur="0.8s" repeatCount="indefinite"/></line>
  ...
  <circle cx="780" cy="30" r="5" fill="#39ff14"><animate attributeName="opacity" values="1;0.4;1" dur="1.5s" repeatCount="indefinite"/></circle>
...
<svg width="860" height="240" viewBox="0 0 860 240" xmlns="http://www.w3.org/2000/svg">
  ...
  <text x="40" y="75" font-family="JetBrains Mono" font-size="12" fill="#888899">React / Next.js</text>
  <rect x="160" y="67" width="240" height="14" rx="7" fill="#1a1a2e"/>
  <rect x="160" y="67" width="0" height="14" rx="7" fill="url(#skillGrad)"><animate attributeName="width" from="0" to="228" dur="1.5s" fill="freeze"/></rect>
  <text x="40" y="105" font-family="JetBrains Mono" font-size="12" fill="#888899">TypeScript</text>
  <rect x="160" y="97" width="240" height="14" rx="7" fill="#1a1a2e"/>
  <rect x="160" y="97" width="0" height="14" rx="7" fill="url(#skillGrad)"><animate attributeName="width" from="0" to="216" dur="1.5s" fill="freeze" begin="0.1s"/></rect>
  <text x="40" y="135" font-family="JetBrains Mono" font-size="12" fill="#888899">Node.js</text>
  <rect x="160" y="127" width="240" height="14" rx="7" fill="#1a1a2e"/>
  <rect x="160" y="127" width="0" height="14" rx="7" fill="url(#skillGrad)"><animate attributeName="width" from="0" to="228" dur="1.5s" fill="freeze" begin="0.2s"/></rect>
  <text x="40" y="165" font-family="JetBrains Mono" font-size="12" fill="#888899">PostgreSQL</text>
  <rect x="160" y="157" width="240" height="14" rx="7" fill="#1a1a2e"/>
  <rect x="160" y="157" width="0" height="14" rx="7" fill="url(#skillGrad)"><animate attributeName="width" from="0" to="216" dur="1.5s" fill="freeze" begin="0.3s"/></rect>
  <text x="40" y="195" font-family="JetBrains Mono" font-size="12" fill="#888899">Tailwind CSS</text>
  <rect x="160" y="187" width="240" height="14" rx="7" fill="#1a1a2e"/>
  <rect x="160" y="187" width="0" height="14" rx="7" fill="url(#skillGrad)"><animate attributeName="width" from="0" to="216" dur="1.5s" fill="freeze" begin="0.4s"/></rect>
  <text x="400" y="75" font-family="JetBrains Mono" font-size="12" fill="#888899">Python</text>
  <rect x="520" y="67" width="240" height="14" rx="7" fill="#1a1a2e"/>
  <rect x="520" y="67" width="0" height="14" rx="7" fill="url(#skillGrad)"><animate attributeName="width" from="0" to="204" dur="1.5s" fill="freeze" begin="0.5s"/></rect>
  <text x="400" y="105" font-family="JetBrains Mono" font-size="12" fill="#888899">GraphQL</text>
  <rect x="520" y="97" width="240" height="14" rx="7" fill="#1a1a2e"/>
  <rect x="520" y="97" width="0" height="14" rx="7" fill="url(#skillGrad)"><animate attributeName="width" from="0" to="192" dur="1.5s" fill="freeze" begin="0.6s"/></rect>
  <text x="400" y="135" font-family="JetBrains Mono" font-size="12" fill="#888899">AWS</text>
  <rect x="520" y="127" width="240" height="14" rx="7" fill="#1a1a2e"/>
  <rect x="520" y="127" width="0" height="14" rx="7" fill="url(#skillGrad)"><animate attributeName="width" from="0" to="204" dur="1.5s" fill="freeze" begin="0.7s"/></rect>
  <text x="400" y="165" font-family="JetBrains Mono" font-size="12" fill="#888899">Docker</text>
  <rect x="520" y="157" width="240" height="14" rx="7" fill="#1a1a2e"/>
  <rect x="520" y="157" width="0" height="14" rx="7" fill="url(#skillGrad)"><animate attributeName="width" from="0" to="204" dur="1.5s" fill="freeze" begin="0.8s"/></rect>
</svg>
...
<svg width="860" height="300" viewBox="0 0 860 300" xmlns="http://www.w3.org/2000/svg">
  ...
  <rect x="30" y="50" width="0" height="80" rx="8" fill="#1a1a2e"><animate attributeName="width" from="0" to="160" dur="1.5s" fill="freeze"/></rect>
  ...
  <rect x="210" y="50" width="0" height="80" rx="8" fill="#1a1a2e"><animate attributeName="width" from="0" to="120" dur="1.5s" fill="freeze" begin="0.1s"/></rect>
  ...
  <rect x="390" y="50" width="0" height="80" rx="8" fill="#1a1a2e"><animate attributeName="width" from="0" to="140" dur="1.5s" fill="freeze" begin="0.2s"/></rect>
  ...
  <rect x="570" y="50" width="0" height="80" rx="8" fill="#1a1a2e"><animate attributeName="width" from="0" to="140" dur="1.5s" fill="freeze" begin="0.3s"/></rect>
  ...
  <rect x="120" y="157" width="0" height="16" rx="4" fill="url(#dataGrad)"><animate attributeName="width" from="0" to="200" dur="1.5s" fill="freeze" begin="0.5s"/></rect>
  <text x="40" y="195" font-family="JetBrains Mono" font-size="11" fill="#888899">JAVASCRIPT</text>
  <rect x="120" y="187" width="0" height="16" rx="4" fill="url(#dataGrad)"><animate attributeName="width" from="0" to="160" dur="1.5s" fill="freeze" begin="0.6s"/></rect>
  <text x="40" y="225" font-family="JetBrains Mono" font-size="11" fill="#888899">PYTHON</text>
  <rect x="120" y="217" width="0" height="16" rx="4" fill="url(#dataGrad)"><animate attributeName="width" from="0" to="100" dur="1.5s" fill="freeze" begin="0.7s"/></rect>
  <text x="40" y="265" font-family="JetBrains Mono" font-size="11" fill="#888899">ACTIVITY</text>
...
|---|---|
| [velvron-labs](https://github.com/supernovaprime/velvron-labs) | Company website/portfolio |
| [portfolio](https://github.com/supernovaprime/portfolio) | Personal portfolio |
| [Backend](https://github.com/supernovaprime/Backend) | Backend API services |
| [Examination](https://github.com/supernovaprime/Examination) | 3D WebGL scene |
...
<p align="center">
  ...
  <a href="https://supernovaprimeportfolio.vercel.app"><img src="https://img.shields.io/badge/Portfolio-0a0a12?style=for-the-badge&logo=vercel&logoColor=39ff14" /></a>
  <a href="mailto:ebenezerayimful@gmail.com"><img src="https://img.shields.io/badge/Email-0a0a12?style=for-the-badge&logo=gmail&logoColor=ff6b35" /></a>
</p>
